  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        backdropClassName="dialog-backdrop--inner"
        title={t('twoFactor.removeConfirm.title')}
        description={t('twoFactor.removeConfirm.description')}
        confirmLabel={t('twoFactor.removeConfirm.confirm')}
