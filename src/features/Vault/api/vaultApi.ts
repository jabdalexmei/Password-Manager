...
export async function listBankCards(): Promise<BackendBankCardItem[]> {
  return invoke('list_bank_cards');
}

export async function listDeletedBankCards(): Promise<BackendBankCardItem[]> {
  return invoke('list_deleted_bank_cards');
}
