...
const detectSystemLanguage = (): Language => {
  ...
  const browserLanguage = win.navigator.language.toLowerCase();
  return browserLanguage.startsWith('ru') ? 'ru' : FALLBACK_LANGUAGE;
};
...
const resolveInitialLanguage = (): Language => readStoredLanguage() ?? detectSystemLanguage();
